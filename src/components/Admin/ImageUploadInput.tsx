    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="space-y-3">
        ...
        {!showUrlInput && isBase64 ? (
          <div className="relative group rounded-xl overflow-hidden border border-pesantren-green/30 bg-pesantren-green/5 p-2 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[9px] text-gray-400">Siap disimpan di database</p>
            </div>
            <button 
              type="button"
              onClick={() => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 p-4 border-2 border-dashed border-gray-100 rounded-xl hover:border-pesantren-green hover:bg-pesantren-green/5 transition-all text-xs font-bold text-gray-500 hover:text-pesantren-green"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 p-4 border border-gray-100 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all text-xs font-bold text-gray-400"
            >
              <LinkIcon size={16} />
              Gunakan Link URL
            </button>
        ...
        {showUrlInput && (
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-100 p-4 pl-12 rounded-xl focus:ring-2 focus:ring-pesantren-green outline-none text-xs font-medium"
